---
title: "Starter mounted quickstart"
description: "Routed winner for the docs/quickstart.mdx overlap fixture"
---

This page should win over `yangleyland/docs-wallis/docs/quickstart.mdx` when `docs-starter` is
mounted at `docs`.
...
Prod test for ENG-9454 multi-repo preview handling.
